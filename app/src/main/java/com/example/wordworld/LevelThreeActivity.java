...
public class LevelThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        letterBoxes = new EditText[][]{
                {findViewById(R.id.letter1_row1), findViewById(R.id.letter2_row1), findViewById(R.id.letter3_row1), findViewById(R.id.letter4_row1), findViewById(R.id.letter5_row1), findViewById(R.id.letter6_row1)},
                {findViewById(R.id.letter1_row2), findViewById(R.id.letter2_row2), findViewById(R.id.letter3_row2), findViewById(R.id.letter4_row2), findViewById(R.id.letter5_row2), findViewById(R.id.letter6_row2)},
                {findViewById(R.id.letter1_row3), findViewById(R.id.letter2_row3), findViewById(R.id.letter3_row3), findViewById(R.id.letter4_row3), findViewById(R.id.letter5_row3), findViewById(R.id.letter6_row3)},
                {findViewById(R.id.letter1_row4), findViewById(R.id.letter2_row4), findViewById(R.id.letter3_row4), findViewById(R.id.letter4_row4), findViewById(R.id.letter5_row4), findViewById(R.id.letter6_row4)},
                {findViewById(R.id.letter1_row5), findViewById(R.id.letter2_row5), findViewById(R.id.letter3_row5), findViewById(R.id.letter4_row5), findViewById(R.id.letter5_row5), findViewById(R.id.letter6_row5)}
        };
    ...
    private void updateWordCount(final LevelThreeActivity.OnWordCountUpdatedListener listener) {
        ...
        userDatabaseReference.child("metaData").child("l3DateTried").get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                if (!isNewDay(savedDate)) {
                    ...
                    userDatabaseReference.child("metaData").child("l3WordGuess").get().addOnCompleteListener(guessTask -> {
    ...
    private void resetAttempts() {
        ...
        currentWordGuess = 0;
        userDatabaseReference.child("metaData").child("l3AttemptsLeft").setValue(currentAttemptsLeft);
        userDatabaseReference.child("metaData").child("l3WordGuess").setValue(currentWordGuess);
    }
