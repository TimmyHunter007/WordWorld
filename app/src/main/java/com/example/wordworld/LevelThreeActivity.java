...
public class LevelThreeActivity extends AppCompatActivity {
    ...
    private void initializeLetterBoxes() {
        //initialize 5 row and 6 columns for level three
        letterBoxes = new EditText[5][6]; // 5 rows, 6 columns for 6-letter words

        // Loop through rows and columns to find the EditText IDs
